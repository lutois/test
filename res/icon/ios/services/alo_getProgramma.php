<?php
/* ------------------------------------------------------------------------------
	 Naam: 		alo_getProgramma.php
	 Functie: Ophalen (XML) programma voor gekozen ploeg van huidige vereniging
...
$URL			= "http://www.antilopen.nl/competitie/programma.asp?h=f&ci=267&t=$ploeg&w=1&voornamen=true&xml=267";
$ch			  = curl_init( $URL );
